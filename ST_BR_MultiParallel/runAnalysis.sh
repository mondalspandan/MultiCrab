...
until xrdcp -f SkimmedTree.root root://se01.indiacms.res.in//dpm/indiacms.res.in/home/cms/store/user/spmondal/t3store2/bbDM_SkimmedTrees_bkg_ttbar_180121/"$2"/SkimmedTree_"$3".root; do
  sleep 60
done
